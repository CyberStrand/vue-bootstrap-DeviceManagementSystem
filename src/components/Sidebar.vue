    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li v-show="todo_visible">
        <router-link :to="Todoroute()" class="nav-link text-white" :class="{ 'active': isActive(Todoroute()) }">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2-circle pe-none me-2" viewBox="0 0 16 16">
      ...
      <li v-show="rank_visible">
        <router-link :to="Rankroute()" class="nav-link text-white" :class="{ 'active': isActive(Rankroute()) }">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-half pe-none me-2" viewBox="0 0 16 16">
      ...
      <li v-show="feedbackSys_visible">
        <router-link :to="feedbackSysRoute()" class="nav-link text-white" :class="{ 'active': isActive(feedbackSysRoute()) }">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-square-text-fill pe-none me-2" viewBox="0 0 16 16">
